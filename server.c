...
const char* lookup(const char* path)
{
    ...
    if(temp != NULL)
    {
        ...
        if(strcasecmp(temp, ".css") == 0)
        {
            return "text/css";
        }
        else if(strcasecmp(temp, ".html") == 0)
        {
            return "text/html";
        }
        else if(strcasecmp(temp, ".gif") == 0)
        {
            return "image/gif";
        }
        else if(strcasecmp(temp, ".ico") == 0)
        {
            return "image/x-icon";
        }
        else if(strcasecmp(temp, ".jpg") == 0)
        {
            return "image/jpeg";
        }
        else if(strcasecmp(temp, ".js") == 0)
        {
            return "text/javascript";
        }
        else if(strcasecmp(temp, ".php") == 0)
        {
            return "text/x-php";
        }
        else if(strcasecmp(temp, ".png") == 0)
        {
            return "image/png";
        }
    }
...
char* indexes(const char* path)
{
    ...
    {
        temp_path[j] = tolower(temp_path[j]);
    }


    char* temp1 = malloc(length + 12);
    char* temp2 = malloc(length + 12);

    if ((strstr(temp_path, "index.php") != NULL) || (strstr(temp_path, "index.html") != NULL))
    {
        strcpy(temp1, temp_path);
        if (access(temp1, F_OK) != -1)
        {
            free(temp2);
            return temp1;
        }
    }
    else if (temp_path[length - 2] !='/')
    {
        strcpy(temp1, temp_path);
        strcat(temp1, "/");
        strcpy(temp2, temp_path);
        strcat(temp2, "/");
    }
    else
    {
